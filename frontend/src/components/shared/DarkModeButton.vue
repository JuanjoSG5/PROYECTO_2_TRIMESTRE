<template>
    ...
    <label class="dark-button" for="darkmode-toggle">
        ...
        <svg version="1.1" class="moon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            x="0px" y="0px" viewBox="0 0 49.739 49.739" style="enable-background:new 0 0 49.739 49.739;"
            xml:space="preserve">
...
label:after {
    ...
    top: .25rem;
    left: .4rem;
    background: linear-gradient(180deg, var(--vt-c-black),var(--vt-c-black-soft));
    border-radius: 180px;
...
input:checked+label:after {
    ...
    background: linear-gradient(180deg, var(--vt-c-black), var(--vt-c-black-mute));
}
