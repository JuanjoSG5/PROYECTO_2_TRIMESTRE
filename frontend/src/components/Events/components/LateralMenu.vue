<template>
    <aside :class="{ 'lateral-menu': true, 'retracted': isMenuRetracted }">
      <h2 class="menu-title" @click="toggleMenu">
        ...
        <span><Icon :class="[isMenuRetracted ? 'hidden-menu-arrow' : 'hidden-arrow']" icon="solar:double-alt-arrow-right-line-duotone" /></span>
      </h2>
      ...
      <section class="prioritary-events">
        <h2><Icon class="down-arrow" icon="lets-icons:arrow-drop-down-big" /> Prioritary</h2>
        <ul class="prioritary-list">
          <li class="prioritary-event">Example Prioritary event</li>
        </ul>
      </section>
      <section class="events">
        <h2><Icon class="down-arrow" icon="lets-icons:arrow-drop-down-big" /> Events</h2>
    ...
    .lateral-menu {
        ...
        & .prioritary-events, .events{
            ...
            & h2 {
                ...
                &:hover .down-arrow {
                    transform: rotate(360deg); /* Adjust the degree as needed */
                }
            }
            & .prioritary-list, .events-list{
                opacity: 0;
                max-height: 0;
                overflow: hidden;
                width: 100%;
                ...
                & .prioritary-event:hover, .event:hover{
                    background-color: rgba(39, 55, 77, 0.886);
                    color: rgba(221, 230, 237, 0.813);
                    cursor: pointer;
                }
